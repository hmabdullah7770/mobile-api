...
import discountproductpost from './routes/store/DiscountProducts/store.discountproductandpost.route.js'
import discountproduct from './routes/store/DiscountProducts/store.discountproduct.route.js'
...
app.use('/api/v1/stores', discountproductpost);
